...
export function PostPurchaseOffer({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onProceedWithoutOffers()}>
      <DialogContent className="max-w-2xl glass border-white/10 p-0 overflow-hidden sm:rounded-3xl w-[90vw] sm:w-full mx-auto max-h-[85vh] overflow-y-auto outline-none">
