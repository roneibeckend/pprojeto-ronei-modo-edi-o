  ...
  return (
    <div className="flex h-dvh w-full overflow-hidden bg-[#0a0a0a] text-foreground">
      ...
      <div className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <main className="min-w-0 min-h-0 flex-1 overflow-y-auto overflow-x-hidden [-webkit-overflow-scrolling:touch] px-4 py-4 pb-24 lg:px-8 lg:py-8 lg:pb-8 3xl:max-w-[1800px] 3xl:mx-auto w-full">
          <Outlet />
        </main>
        <PwaInstallBanner />
      </div>
