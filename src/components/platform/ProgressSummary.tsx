...
export function ProgressSummary({ totalProgress, startedCount, finishedCount, streak }: ProgressSummaryProps) {
  return (
    <div className="mb-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
      <div className="glass flex flex-col items-center justify-center rounded-2xl p-4 text-center">
        <div className="mb-1 text-[10px] font-bold uppercase tracking-widest text-muted-foreground">Progresso Total</div>
        <div className="font-display text-2xl font-black text-gold">{totalProgress}%</div>
      ...
      <div className="glass flex flex-col items-center justify-center rounded-2xl p-4 text-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-2xl font-black">{startedCount}</span>
        </div>
      </div>
      ...
      <div className="glass flex flex-col items-center justify-center rounded-2xl p-4 text-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-display text-2xl font-black">{finishedCount}</span>
        </div>
      </div>
      ...
      <div className="glass flex flex-col items-center justify-center rounded-2xl p-4 text-center">
        ...
        <div className="flex items-center gap-2 text-fire">
          ...
          <span className="font-display text-2xl font-black">{streak} dias</span>
        </div>
      </div>
    </div>
  );
