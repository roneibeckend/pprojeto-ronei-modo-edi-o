...
function CourseShowcaseCard({ item, isEnrolled }: { item: any; isEnrolled: boolean }) {
  ...
  return (
    <>
      ...
      />
      <article className={`glass overflow-hidden rounded-2xl transition-all duration-300 ${isLocked ? "opacity-90 grayscale-[0.3]" : "card-tilt shadow-lg"} flex flex-col h-full active:scale-[0.99] touch-action-manipulation relative z-0`}>
